export default class Cursor {
  ...
  createElement = () => {
    ...
    element.classList.add(
      ...
      "mobile-text-selection-tools-cursor-" + this.type
    );
    ...
    if (this.type === "start") {
      element.style.transform = "translateX(100%) rotateX(180deg)";
    }
    ...
    pointWrapper.classList.add("mobile-text-selection-tools-cursor-" + this.type);
